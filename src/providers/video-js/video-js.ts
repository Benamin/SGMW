...
export class VideoJsProvider {
    ...
    danmuFun() {
        ...
        let danmu = videojs.extend(component, {
            ...
            init() {
                ...
                for (let j = 0; j < channel_count; j++) {
                    let doms = [];
                    for (let i = 0; i < max_com_count; i++) {
                        let dom = videojs.dom.createEl('span', {
                            className: 'vjs-right'
                        }, {
                            style: `top:${i * 20}px`
                        });
        ...
        videojs.registerComponent('danmu', danmu);
    }
